...
class DebugAgent:
    def __init__(self, timeout, color, board):
        self.color = color
        self.board = board
...
if __name__ == "__main__":
    critical_state = [
        ["EMPTY", "BLACK", "EMPTY", "EMPTY", "BLACK", "EMPTY", "EMPTY", "EMPTY", "EMPTY"],
        ["EMPTY", "EMPTY", "BLACK", "EMPTY", "EMPTY", "BLACK", "EMPTY", "EMPTY", "EMPTY"],
        ["EMPTY", "EMPTY", "EMPTY", "EMPTY", "WHITE", "EMPTY", "EMPTY", "BLACK", "EMPTY"],
        ["BLACK", "EMPTY", "EMPTY", "EMPTY", "WHITE", "EMPTY", "EMPTY", "EMPTY", "EMPTY"],
        ["BLACK", "EMPTY", "EMPTY", "BLACK", "KING", "BLACK", "EMPTY", "EMPTY", "EMPTY"],
        ["EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "BLACK", "EMPTY"],
        ["WHITE", "EMPTY", "BLACK", "BLACK", "EMPTY", "EMPTY", "WHITE", "EMPTY", "EMPTY"],
        ["EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY", "EMPTY"],
        ["EMPTY", "EMPTY", "WHITE", "EMPTY", "BLACK", "EMPTY", "EMPTY", "EMPTY", "EMPTY"]
    ]
    
    b = Board()
    b.update(critical_state)
    agent = DebugAgent(36000, color=Color.WHITE, board=b)